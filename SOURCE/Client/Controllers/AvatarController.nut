...
class this.Controller.Avatar2 extends this.Controller.Server
{
	...
	{
		return sceneObject.getMeta("copper_shopkeeper") || sceneObject.getMeta("credit_shopkeeper") || sceneObject.getMeta("essence_vendor") || sceneObject.getMeta("vault") || sceneObject.getMeta("clan_registrar") || sceneObject.getMeta("crafter") || sceneObject.getMeta("credit_shop") || sceneObject.hasStatusEffect(this.StatusEffects.TRANSFORMER) || sceneObject.getQuestIndicator() && sceneObject.getQuestIndicator().hasValidQuest() || sceneObject.getQuestIndicator() && sceneObject.getQuestIndicator().hasCompletedNotTurnInQuest() || ::_useableCreatureManager.isUseable(sceneObject.getID());
	}
