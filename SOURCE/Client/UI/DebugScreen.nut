...
class this.Screens.DebugScreen extends this.GUI.Container
{
	...
	function _createInfoPage()
	{
		...
		this.mGodModeStatus = this.GUI.Label("God Mode: OFF");
