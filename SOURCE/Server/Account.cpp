...
PermissionInfo PermissionDef[] = { { Perm_Account, 0, Permission_TweakOther,
		"tweakother" }, { Perm_Account, 0, Permission_TweakSelf, "tweakself" },
		{ Perm_Account, 0, Permission_TweakNPC, "tweaknpc" }, { Perm_Account, 0,
				Permission_TweakClient, "tweakclient" }, { Perm_Account, 0,
				Permission_SysChat, "syschat" }, { Perm_Account, 0,
				Permission_GMChat, "gmchat" }, { Perm_Account, 0,
				Permission_RegionChat, "regionchat" }, { Perm_Account, 0,
				Permission_ForumPost, "forumpost" }, { Perm_Account, 0,
				Permission_ForumAdmin, "forumadmin" }, { Perm_Account, 0,
				Permission_ItemGive, "itemgive" }, { Perm_Account, 0,
				Permission_Debug, "debug" }, { Perm_Account, 0, Permission_Sage,
				"sage" }, { Perm_Account, 0, Permission_FastLoad, "fastload" },
		{ Perm_Account, 0, Permission_Admin, "admin" }, { Perm_Account, 0,
				Permission_PasswordReset, "passwordreset" }, { Perm_Account, 0,
				Permission_Invisible, "invisible" }, { Perm_Account, 0,
				Permission_SelfDiag, "selfdiag" }, { Perm_Account, 0,
				Permission_Troll, "troll" }, { Perm_Account, 0,
				Permission_TrollChat, "trollchat" }, { Perm_Account, 0,
				Permission_Builder, "builder" }, { Perm_Account, 0,
				Permission_FullSet, "fullset" } };
