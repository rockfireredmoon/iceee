...
void SQVM::Raise_ParamTypeError(SQInteger nparam,SQInteger typemask,SQInteger sqtype)
{
    ...
    Raise_Error(_SC("parameter %d has an invalid type '%s' ; expected: '%s'"), nparam, IdType2Name((SQObjectType)sqtype), _stringval(exptypes));
}
