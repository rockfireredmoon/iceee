...
class this.Screens.MorphItemScreen extends this.GUI.Frame
{
	...
	function onValidDropSlot( newSlot, oldSlot )
	{
		...
		//eqslot == this.ItemEquipType.WEAPON_1H || eqslot == this.ItemEquipType.WEAPON_1H_UNIQUE || 
		//	eqslot == this.ItemEquipType.WEAPON_1H_MAIN || eqslot == this.ItemEquipType.WEAPON_1H_OFF || 
		//	eqslot == this.ItemEquipType.WEAPON_2H || eqslot == this.ItemEquipType.WEAPON_RANGED || 

		if (eqslot == this.ItemEquipType.NONE || eqslot == this.ItemEquipType.FOCUS_FIRE || 
			eqslot == this.ItemEquipType.FOCUS_FROST || eqslot == this.ItemEquipType.FOCUS_MYSTIC || 
			eqslot == this.ItemEquipType.FOCUS_DEATH || eqslot == this.ItemEquipType.CONTAINER || 
			eqslot == this.ItemEquipType.COSEMETIC_SHOULDER || eqslot == this.ItemEquipType.COSEMETIC_HIP || 
			eqslot == this.ItemEquipType.RED_CHARM || eqslot == this.ItemEquipType.GREEN_CHARM || 
