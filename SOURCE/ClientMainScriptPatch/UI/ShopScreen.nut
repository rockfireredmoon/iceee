...
class this.Screens.ItemShop extends this.GUI.Frame
{
	...
	constructor()
	{
		...
		this.mShopContainer.addMovingToProperties("itempreview", MoveToProperties(MovementTypes.CLONE));
		...
		this.mBuybackContainer.addMovingToProperties("itempreview", MoveToProperties(MovementTypes.CLONE));
